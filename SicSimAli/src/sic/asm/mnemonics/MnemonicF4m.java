...
public class MnemonicF4m extends Mnemonic {
	...
	public Node parse(Parser parser) throws SyntaxError {
		...
		if (Character.isDigit(parser.lexer.peek()))
			return new InstructionF4 (this, parser.parseNumber(0, (1<<20)-1 ), ni, parser.parseIndexed());
		// symbol
		else if (Character.isLetter(parser.lexer.peek()))
			return new InstructionF4 (this, parser.parseSymbol(), ni, parser.parseIndexed());
		//else
		int dataInt;
		try {
	...
	public String operandToString(Node node){
		InstructionF4 instr = (InstructionF4)node;
