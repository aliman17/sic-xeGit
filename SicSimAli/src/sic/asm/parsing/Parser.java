...
public class Parser {
	...
	private void put34(String string, int opcode, String hint, String desc) {
		switch (string) {
		case "RSUB":
			put(new MnemonicF3(string, opcode, hint, desc)); 
			return;
		default:
			break;
		}

		put(new MnemonicF3m(string, opcode, hint, desc));
		put(new MnemonicF4m("+"+string, opcode, hint, desc));
	}
